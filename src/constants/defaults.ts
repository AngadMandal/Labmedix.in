...
export const DEFAULT_COMPANY_PROFILE: CompanyProfile = {
  name: 'LABMEDIX MULTI-SPECIALITY HEALTHCARE & RESEARCH CENTRE',
  tagline: 'Confident In Care',
  estdYear: '2025',
  logoUrl: '/logo.jpg',
  subtitle: 'Confident In Care • ISO 9001:2015 ACCREDITED • NABH STANDARDS • NABL LABS',
  address: 'Main Health Expressway, Medical Square',
  postOffice: 'Medical Square P.O.',
  policeStation: 'Health City Station',
  ...
  email: 'care@labmedix.org',
  website: 'https://labmedix.org',
  registrationNo: 'WB-MED-REG-2025/08942',
  isoCertification: 'ISO 9001:2015 ACCREDITED • NABH STANDARDS • NABL LABS',
  clinicalLicenseNo: 'CEA/WB/KOL/2025/1102',
  ...
  cardSecurityWatermark: 'LABMEDIX SECURE HEALTHCARE',
  currencySymbol: '₹',
  services: [
    {
      id: 'srv_1',
